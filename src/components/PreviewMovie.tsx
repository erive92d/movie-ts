...
export default function PreviewMovie({previewDetails}:previewProps) {
  ...
  return (
    <div>
        ...
        <div className="modal">
          <div className="modal-box text-white shadow-md shadow-cyan-500" style={{backgroundImage: `url(https://image.tmdb.org/t/p/w500/${previewDetails.backdrop_path})`, backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
